...
call Leds.led1Toggle();
  ...
  */
  ...
  event void Read.readDone(error_t result, uint16_t data) {
    ...
    uint16_t voltage;
   uint16_t voltage_cm;
    call CtpInfo.getVolt_cm(&voltage_cm);
      call CtpInfo.getVolt(&voltage);
    local.reading = voltage_cm;
     local.reading_cm = voltage;
  ...
  static void report_received() { call Leds.led1Toggle(); }
}
